...
* create offer ([9cc5d8d](https://github.com/legend-esc/carbonchain/commit/9cc5d8d7fc60fab035c6e21bf3f9fa786da021f8))
* create offer ([8c8c70a](https://github.com/legend-esc/carbonchain/commit/8c8c70aa89f2b6ecc7c857ccaa61ec82fe26bf2c))
...
* register verifier ([1304af5](https://github.com/legend-esc/carbonchain/commit/1304af5dbf3f605753408042491bcff155939192))
* register verifier ([0cc7b1c](https://github.com/legend-esc/carbonchain/commit/0cc7b1cb3170b8a943da3ec12ab8b1be4f1d6f1f))
* remove verifier ([8c8bb96](https://github.com/legend-esc/carbonchain/commit/8c8bb960b8601d51fe8420c4dd1e205cf440513d))
* remove verifier ([ceac703](https://github.com/legend-esc/carbonchain/commit/ceac7030f6a0892349ba50a1ce002177d28fa8ec))
...
* submit-credit validation ([63f9e42](https://github.com/legend-esc/carbonchain/commit/63f9e42b4e6bd4ea409270024a380bedc6073f83))
* submit-credit validation ([2931a86](https://github.com/legend-esc/carbonchain/commit/2931a86ca59b5cfcaccaf63d088521bcf021cbd1))
...
* bump CI Rust 1.85 → 1.91 for soroban-sdk 26.0.1 MSRV ([6982074](https://github.com/legend-esc/carbonchain/commit/698207425ca5697e78c312de1036360ed0618124))
* CI pipeline — pin Rust 1.81 for contracts, relax ESLint, frontend legacy-peer-deps ([8f2f307](https://github.com/legend-esc/carbonchain/commit/8f2f3070eebe9b5ccd0788715c863b40f6d779ad))
...
* e2e tests — fix imports, valid secret key, add env setup ([1c35f5c](https://github.com/legend-esc/carbonchain/commit/1c35f5c30e40df49f8385f215e75ab547cb74d72))
...
* patch base64ct via Git tag to avoid edition2024 requirement on Rust 1.81 ([ed3be1b](https://github.com/legend-esc/carbonchain/commit/ed3be1bc8b28d11f2fc5cb015c3366aecdf44003))
* pin base64ct to 1.7.0 for Rust 1.81 compat + ignore cargo audit transients ([0d18447](https://github.com/legend-esc/carbonchain/commit/0d18447d7028ea1dd1b496d234aa0ade148dfc4c))
* pin base64ct to v1.8.2 for Rust 1.81 compat ([499f828](https://github.com/legend-esc/carbonchain/commit/499f8288c7c9c0e8d4961dc62a29a0bc0d04c0c1))
* remove invalid --features opt from stellar-cli install ([737c2a3](https://github.com/legend-esc/carbonchain/commit/737c2a306f45112061498704e10caf01fbe3f768))
* resolve all frontend test failures + API lint/test fixes ([94fb984](https://github.com/legend-esc/carbonchain/commit/94fb9848c93ca4d74202a50df2d66c63d3ce4f77))
...
* resolve build errors across Rust contracts, API, and frontend ([be062d1](https://github.com/legend-esc/carbonchain/commit/be062d1acc398825a8c0640b158de4358cb2d531))
...
* restore Cargo.lock from last green CI + keep base64ct Git patch ([d4a3f9a](https://github.com/legend-esc/carbonchain/commit/d4a3f9a6a6719dd75300c51b952b44e5ea40cb68))
...
* update deploy job + script to wasm32v1-none ([19b9a72](https://github.com/legend-esc/carbonchain/commit/19b9a72342fbafd0d497953c42f58ab60f4c2120))
* upgrade CI Rust to 1.85 + wasm32v1-none target + allow-multiple-definition ([2143f23](https://github.com/legend-esc/carbonchain/commit/2143f23283ac2b020a25c45cfb0b462f65a9010f))
